    ...
    return (
        <>
            <div className='flex flex-col md:flex-row bg-[#5f6fff] rounded-lg px-8 md:px-14 lg:px-24 h-180'>
                {/** Left Side */}
                <div className='md:w-1/2 flex flex-col justify-center gap-5 py-12 m-auto md:py-[10vw] md:wb-[-30px]'>
                    ...
                    <a href="#speciality" 
                        onClick={() => navigate('/')} 
                        className='flex cursor-pointer items-center w-62 h-13 gap-3 bg-white px-10 py-4 rounded-full text-gray-600 text-base m-auto md:m-0 hover:scale-110 transition-all duration-300'>
