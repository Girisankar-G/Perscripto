  ...
  return (
    <form className='min-h-[80vh] flex items-center'>
      <div className='flex flex-col gap-3 m-auto items-start p-8 sm:min-w-96 rounded-xl text-zinc-600 text-sm shadow-2xl'>
        ...
        <p>Please {state === 'Sign Up' ? 'Create Acount' : 'Login'} to book an appointment</p>
        {
          state === 'Sign Up' &&
        ...
        {
          state === 'Sign Up' 
          ? <p>Already have a account ? <span onClick={()=>setState('Login')} className='text-[#5f6fff] underline cursor-pointer'>Login here</span></p> 
